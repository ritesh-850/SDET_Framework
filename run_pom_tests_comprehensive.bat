@echo off
echo ===================================================
echo Running POM Classes and Test Classes (Comprehensive)
echo ===================================================
echo.
...
echo.
echo ===================================================
echo Running POM and Test Classes...
echo ===================================================
echo.

REM Run only the regular test classes (excluding database and data-driven tests)
python -m pytest -v .\TEST_CLASS\Test_Login.py .\TEST_CLASS\Test_Dashboard.py .\TEST_CLASS\Test_Profile.py .\TEST_CLASS\Test_Logout.py --alluredir=allure-results
